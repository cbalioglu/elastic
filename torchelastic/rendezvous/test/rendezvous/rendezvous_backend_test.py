...
from torchelastic.rendezvous import RendezvousStateError
from torchelastic.rendezvous.default_rendezvous_handler import RendezvousBackend, Token


class RendezvousBackendTestBase(ABC):
